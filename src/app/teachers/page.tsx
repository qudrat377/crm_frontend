          ...
          {step === "user" ? (
            <div className="space-y-4">
              <div className="flex gap-2 p-1 bg-surface-100 dark:bg-surface-800 rounded-lg">
                <button
                  type="button"
                  className={`flex-1 py-1.5 text-sm font-medium rounded-md transition-all ${userMode === "new" ? "bg-white dark:bg-surface-900 text-surface-900 dark:text-surface-50 shadow-sm" : "text-surface-500 dark:text-surface-400 hover:text-surface-700"}`}
                ...
                <button
                  type="button"
                  className={`flex-1 py-1.5 text-sm font-medium rounded-md transition-all ${userMode === "existing" ? "bg-white dark:bg-surface-900 text-surface-900 dark:text-surface-50 shadow-sm" : "text-surface-500 dark:text-surface-400 hover:text-surface-700"}`}
              ...
              {userMode === "new" ? (
                ...
                <div className="space-y-4">
                  <div className="p-3 bg-brand-50 rounded-xl text-sm text-brand-700 border border-brand-100">
                    Oldin ro'yxatdan o'tgan foydalanuvchini tanlab, unga o'qituvchi profilini yarating.
                  </div>
                  <SearchableSelect
            ...
            <form className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Input
                  ...
                  {...regProfile("phone")}
                />
                {/* ✅ Controller bilan to'g'ri ishlaydi */}
                <Controller
                  name="branchId"
                  control={profileControl}
